      ...
      <div className="info-overlay">
        <div className="info-box">
          ...
          <div className="fact-container">
            <div className="fact">
              <span className="fact-number">752</span><br/><br/>
              <span className="fact-label">CLIENTES ATENDIDOS</span>
            </div>
            <div className="fact">
              <span className="fact-number">17</span><br/><br/>
              <span className="fact-label">ESTADOS ATENDIDOS</span>
            </div>
            <div className="fact">
              <span className="fact-number">3500</span><br/><br/>
              <span className="fact-label">PROJETOS ANALISADOS</span>
            </div>
            <div className="fact">
              <span className="fact-number">16</span><br/><br/>
